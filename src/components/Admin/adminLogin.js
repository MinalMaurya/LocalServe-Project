...
export default function AdminLogin() {
  ...
  const handleLogin = () => {
    ...
    const users = JSON.parse(localStorage.getItem("registeredAdmin")) || [];
    ...
    if (matchedUser.role === "admin" || matchedUser.role === "Admin") {
    ...
    <div className="split-auth-page">
      ...
      >
        <div className="auth-left-content">
          ...
          <h2 className="brand-tagline">Welcome Back Admin</h2>
          <p className="brand-description">
            Sign in to continue accessing and managing trusted local service providers.
          </p>

          <div className="feature-list">
            <div className="feature-item">
              <div className="feature-icon"><FaCheckCircle /></div>
              <div className="feature-text">Approve and verify services</div>
            </div>
            <div className="feature-item">
              <div className="feature-icon"><FaShieldAlt /></div>
              <div className="feature-text">Keep the platform safe and clean</div>
            </div>
            <div className="feature-item">
              <div className="feature-icon"><FaClock /></div>
              <div className="feature-text">Monitor listings in real-time</div>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="auth-form-container">
          ...
          <div className="auth-footer">
            ...
            <a href="/admin/signup" className="auth-link">Go to Admin signup</a>
          </div>
        </div>
      </motion.div>
    </div>
